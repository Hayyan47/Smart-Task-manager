...
- Signup/Login now use the TaskMate logo directly in the purple top header with no extra white logo card
...
- Profile Information tab in the menu shows name, Gmail/email, and profile photo frame
